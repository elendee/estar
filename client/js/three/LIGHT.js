...
import { 
	Lensflare, 
	LensflareElement 
} from '/three-patch/examples/jsm/objects/Lensflare.js'

import env from '../env.js'

// import { removeBloom } from './ComposerSelectiveBloom.js'
...
const hemispherical = new HemisphereLight( 0x5599cc, 0xffffff, .05)
